...
function main() {
    ...
    const creature1 = new Individual_1.Individual(1, false, "Asgard", 200, ["small", "red"]);
    const creature2 = new Individual_1.Individual(2, true, "Kashyyyk", 16, ["intelligent", "blue-eyed"]);
